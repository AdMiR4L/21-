                ...
                <div className="row">
                    <div className="col-lg-6">
                        ...
                        <div className="game-page-info">
                            ...
                            {localStorage.getItem("authToken") && (JSON.parse(localStorage.userDetails).id === 1 || JSON.parse(localStorage.userDetails).id === 17) ?
                            ...
                            {!logLoading && localStorage.getItem("authToken") && (JSON.parse(localStorage.userDetails).id === 1 || JSON.parse(localStorage.userDetails).id === 17) ?
                                <Modal
                                    show={showLogModal}
