                                                    ...
                                                    <li className="single-chair-container">
                                                        ...
                                                        <span className="number">
                                                             #<span className="key">{game.capacity}</span>
                                                                ...
                                                                {reserves.find(obj => parseInt(JSON.parse(obj.chair_no)) === game.capacity).user && reserves.find(obj => parseInt(JSON.parse(obj.chair_no)) === game.capacity).user.avatar ?
                                                                    <div className="avatar-img-container">
                                                                        <img src={reserves.find(obj => parseInt(JSON.parse(obj.chair_no)) === game.capacity).user.avatar}
                                                                             alt={reserves.find(obj => parseInt(JSON.parse(obj.chair_no)) === game.capacity).user.nickname ?? reserves.find(obj => parseInt(JSON.parse(obj.chair_no)) === game.capacity).user.name}/>
                                                                    </div>
                                                                    :
                                                                    <svg className="chair-icon unavailable"
                                                                         xmlns="http://www.w3.org/2000/svg"
