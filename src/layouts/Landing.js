        ...
        <section className="landing">
            ...
            <div className="container pr-2">
                <div className="row no-gutters">
                    <div className="col-lg-6 col-7 landing-content">
                    ...
                    <div className="col-12 d-none d-md-block">
                        {!props.isLoading && props.weekChampion ?
                            <div className="top-player">
                                <div className="player-card">
                                    <div className="player-avatar">
                                        {props.weekChampion.avatar ?
                                            <img src={props.weekChampion.avatar} alt={props.weekChampion.name}/>
                                            :
                                            <img src={Avatar} alt={props.weekChampion.name}/>
                                        }
                                    </div>
                ...
                <div className="row d-md-none">
                    <div className="col-12">
                        {!props.isLoading && props.weekChampion ?
                            <div className="top-player phone-champ">
                                <div className="player-card">
                                    <div className="player-avatar">
                                        {props.weekChampion.avatar ?
                                            <img src={props.weekChampion.avatar} alt={props.weekChampion.name}/>
                                ...
                                <ul className="content">
                                    <li className="en pl-2">week champ</li>
                                    <li className="fa">بــازیـکــن بـرتـر هـفـتـه</li>
                                </ul>
                            ...
                            <div className="top-player phone-champ">
                                <div className="player-card">
                                    ...
                                    <ul className="user-info">
                                        ...
                                        <li className="awards">
                                            <Skeleton width={"50px"} height={"20px"} borderRadius={0}/>
                                            <Skeleton width={"50px"} height={"20px"} borderRadius={0}/>
                                        </li>
                                    </ul>
                                    <img className="golden-badge" src={GoldenBadgeIcon} alt="golden-badge"/>
